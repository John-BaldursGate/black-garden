...
dnf5 install dnf5-plugins qt5ct qt6ct kvantum kvantum-qt5 btop distrobox fastfetch gamescope mangohud rocm-smi steam-devices wine libguestfs-tools libvirt-daemon-config-network libvirt-daemon-kvm python3-libguestfs qemu-kvm virt-install virt-manager virt-top virt-viewer -y
